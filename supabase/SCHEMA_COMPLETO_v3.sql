-- ================================================================
-- SCHEMA_COMPLETO v3 - DEFINITIVO (banco de testes zerado)
-- ================================================================
...
-- =====================================================
-- PREAMBULO: Tabelas base que precisam existir ANTES
-- das migrations (o Supabase cria profiles via auth,
-- as demais sao criadas aqui para evitar erros de ordem)
-- =====================================================

-- profiles (criada pelo Supabase Auth - base para migration 001)
...
-- pedidos (base para migrations 001-026)
...
-- feriados (criada em 007 mas referenciada em 032)
...
-- afiliados (criada em 041, referenciada em outra migration)
