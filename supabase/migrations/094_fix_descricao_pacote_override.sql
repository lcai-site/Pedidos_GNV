-- ================================================================
-- FIX: Proteger descricao_pacote editada manualmente
-- Bug: O ON CONFLICT DO UPDATE sobrescrevia o campo mesmo
-- quando o pedido tinha foi_editado = TRUE. Agora respeita.
-- ================================================================
...
BEGIN
    ...
    LOOP
        ...
        -- ============================================================
        -- INSERIR NA CONSOLIDADA (COM PROTEÇÃO COMPLETA)
        -- Nunca atualiza se já existe com código de rastreio OU foi editado
        -- ============================================================
        ...
        -- ✅ FIX: Protege tanto etiquetados (codigo_rastreio) quanto editados (foi_editado)
...
SELECT 'Fix aplicado: consolidar_pedidos_ticto agora protege pedidos com foi_editado = TRUE' as status;
