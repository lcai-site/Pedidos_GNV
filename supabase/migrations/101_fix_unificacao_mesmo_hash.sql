-- ================================================================
-- MIGRATION 101: ADICIONANDO CODIGO UNICO E FIX DE UNIFICACAO
-- ================================================================

-- 1. Cria a coluna codigo_unico do jeitinho que o front e o Sheets usam:
ALTER TABLE ticto_pedidos ADD COLUMN IF NOT EXISTS codigo_unico TEXT GENERATED ALWAYS AS (order_id::text || COALESCE(offer_code, '')) STORED;
...
BEGIN
    ...
    LOOP
        ...
        LOOP
            ...
            -- Agora agrupamos visualmente os filhos usando a ideia do usuario (codigo_unico) ao invez de duplicar o transaction_hash
