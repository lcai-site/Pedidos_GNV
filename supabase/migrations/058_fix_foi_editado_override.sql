-- ================================================================
-- MIGRATION 058: Proteger Edições Manuais do Produto no Consolidar
-- Data: 2026-03-12
--
-- O que essa migration resolve:
-- O Webhook do Ticto executa o consolidar_pedidos_ticto() constantemente.
-- A procedure corretamente não deletava pedidos editados (foi_editado),
-- mas a cláusula ON CONFLICT DO UPDATE sobrescrevia silenciosamente
-- o descricao_pacote. A partir desta migração, se foi_editado = TRUE,
-- o descricao_pacote não será mais destruído pela consolidação.
-- ================================================================
