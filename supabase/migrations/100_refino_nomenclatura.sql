-- ================================================================
-- MIGRATION 100: REFINO DE NOMENCLATURA (REMOÇÃO DE "FRASCOS")
-- ================================================================
...
BEGIN
    ...
    LOOP
        ...
        -- Limpeza da nomenclatura do pai
        ...
        v_nome_oferta := REGEXP_REPLACE(v_nome_oferta, '(?i)\s*frascos\b', '', 'i'); -- Remove "frascos"
