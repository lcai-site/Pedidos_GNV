-- ================================================================
-- SCHEMA_COMPLETO v2 - Para banco de testes ZERADO
-- Gerado automaticamente. Execute INTEIRO no SQL Editor do Supabase.
-- ================================================================
-- ANTES DE RODAR: Zere o banco de testes com:
--   DROP SCHEMA public CASCADE;
--   CREATE SCHEMA public;
--   GRANT ALL ON SCHEMA public TO postgres, anon, authenticated, service_role;
-- ================================================================

-- BASE: profiles (criada pelo Supabase Auth - precisa existir antes das migrations)
...
-- BASE: pedidos (referenciada nas primeiras migrations)
